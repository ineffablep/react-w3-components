...
var Navbar = function (_Component) {
  ...
  _createClass(Navbar, [{
    ...
    value: function renderToggleNav(toggleNav) {
      var className = toggleNav.className,
          title = toggleNav.title,
          icon = toggleNav.icon;

      return React.createElement(
        "a",
        {
          className: "w3-bar-item w3-button w3-hide-medium w3-hide-large w3-right " + className,
    ...
    value: function renderNavLinks(navLinks, pullClass) {
      ...
      return React.createElement(
        "div",
        { className: "w3-hide-small " + pullClass + " " + className },
    ...
    value: function renderMobileNav(links) {
      ...
      var navLinks = [].concat(_toConsumableArray(rightLinks.links), _toConsumableArray(leftLinks.links));
      return React.createElement(
        "nav",
        {
